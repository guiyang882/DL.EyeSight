...
def main():
    ...
    parser.add_argument('--det_frames_folder',
                        default='results/det_frames/', type=str)
    parser.add_argument('--det_result_folder',
                        default='results/det_results/', type=str)
    parser.add_argument('--result_folder', default='summary_result/', type=str)
    parser.add_argument('--summary_file',
                        default='results/results.txt', type=str)
    parser.add_argument('--output_name', default='results/output.mp4', type=str)
