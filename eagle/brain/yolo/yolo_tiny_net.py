...
class YoloTinyNet(Net):
    ...
    def inference(self, images):
        ...
        temp_conv = self.conv2d('conv' + str(conv_num), images, [3, 3, 3, 16],
                                stride=1)
        conv_num += 1
