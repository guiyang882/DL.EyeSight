...
def save_best_overlap(val_bbox, output_bbox):
    ...
    print("Total False Positive Bounding Boxes: "+ str(
        len_output_bbox-count_best_bbox))
    print("BBox/Frame Number: "+ str(float(count_best_bbox)/float(
        len_val_bbox)))
    print("Missing BBox/Frame Number: "+ str(float(float(
        count_missing_boxes)/float(len_val_bbox))))
    print("False Positive BBox/Frame Number: "+ str(float(float(
        len_output_bbox-count_best_bbox)/float(len_val_bbox))))
